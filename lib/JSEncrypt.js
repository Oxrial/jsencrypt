...
var JSEncrypt = /** @class */ (function () {
    ...
    JSEncrypt.prototype.doDecrypt = function (hexText, options) {
        var decrypted = "";
        switch (options.by) {
            case "PublicKey":
     ...
     * @returns
     */
    JSEncrypt.prototype.decryptOxr = function (cipherText, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        try {
            ...
            if (hexText.length <= maxLength) {
                ...
                var plainText = arr.reduce(function (acc, cur) {
                    return acc + _this.doDecrypt(cur, options);
                }, "");
                return plainText;
            }
        }
    ...
    JSEncrypt.prototype.doEncrypt = function (str, options) {
        var encrypted = "";
        switch (options.by) {
            case "PrivateKey":
     ...
     * @returns
     */
    JSEncrypt.prototype.encryptOxr = function (str, options) {
        if (options === void 0) { options = {}; }
        try {
            // @ts-ignore
