...
var JSEncrypt = /** @class */ (function () {
    ...
    JSEncrypt.prototype.doDecrypt = function (str, options) {
        var decrypted = "";
        switch (options.by) {
            case "PublicKey":
     ...
     * @returns
     */
    JSEncrypt.prototype.decryptExt = function (cipherText, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        try {
     ...
     * @returns
     */
    JSEncrypt.prototype.encryptExt = function (str, options) {
        if (options === void 0) { options = {}; }
        try {
            // @ts-ignore
